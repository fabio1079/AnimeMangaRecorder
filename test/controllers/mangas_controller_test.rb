...
class MangasControllerTest < ActionController::TestCase
  ...
  test "should create manga" do
    assert_difference('Manga.count') do
      post :create, manga: { chapter: @manga.chapter, chapter_title: @manga.chapter_title, title: @manga.title, volume: @manga.volume }
    end
  ...
  test "should update manga" do
    patch :update, id: @manga, manga: { chapter: @manga.chapter, chapter_title: @manga.chapter_title, title: @manga.title, volume: @manga.volume }
    assert_redirected_to manga_path(assigns(:manga))
  end
