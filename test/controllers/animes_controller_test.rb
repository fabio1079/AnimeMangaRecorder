...
class AnimesControllerTest < ActionController::TestCase
  ...
  test "should create anime" do
    assert_difference('Anime.count') do
      post :create, anime: { episode: @anime.episode, season: @anime.season, season_title: @anime.season_title, title: @anime.title }
    end
  ...
  test "should update anime" do
    patch :update, id: @anime, anime: { episode: @anime.episode, season: @anime.season, season_title: @anime.season_title, title: @anime.title }
    assert_redirected_to anime_path(assigns(:anime))
  end
